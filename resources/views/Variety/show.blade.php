...
<script type="text/javascript">
 ...
 function drawMarkerArea(data) {
		...
		console.log(data);
		 ...
		 var facilities = xf.dimension(function(d) { return d.datapoint.geolocation.latitude+","+d.datapoint.geolocation.longitude });
		...
		//
		var panchayath = xf.dimension(function(d){ return d.datapoint.pt});
